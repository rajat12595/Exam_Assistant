                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Exam</h1>                            </div>
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.examList}">
                                                <tr>
                                                    ...
                                                    <td>${i.semesterVO.semName}</td>
                                                    <td>${i.examTitle}</td>
                                                    <td>${i.examDate}</td>
                                                    <td>${i.examTimeSlot}</td>
                                                    <td>${i.examDescription}</td>
                                                    <td><a href="<%=request.getContextPath()%>/ExamController?flag=EditExam&id=${i.examId}">Edit</a>/<a href="<%=request.getContextPath() %>/ExamController?flag=Delete&id=${i.examId}">Delete</a></td>
                                                </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
