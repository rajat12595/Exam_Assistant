                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Branch</h1>                            </div>
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.branchList}">
                                                <tr>
                                                    ...
                                                    <td>${i.branchName}</td>
                                                    <td>${i.branchDes}</td>
                                                    <td><a href="<%=request.getContextPath()%>/BranchController?flag=editBranch&id=${i.branchId}">Edit</a>/<a href="<%=request.getContextPath()%>/BranchController?flag=deleteBranch&id=${i.branchId}">Delete</a></td>
                                                    </tr>
                                              </c:forEach>
                                            </tbody>
                                        </table>
