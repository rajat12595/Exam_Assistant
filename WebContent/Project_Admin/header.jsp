                    ...
                    <ul class="info-menu right-links list-inline list-unstyled">
                        <li class="profile">
                            <a href="#" data-toggle="dropdown" class="toggle">
                                ...
                                <span>Prof. ${sessionScope.loginobj.fname} ${sessionScope.loginobj.lname}  <i class="fa fa-angle-down"></i></span>
                         ...
                         <li class="chat-toggle-wrapper">
                            <a href="#" data-toggle="chatbar" class="toggle_chat">
                                <i class="fa fa-comments" style="display:none"></i>
                                <span class="badge badge-warning" style="display:none"> 9</span>
                                <i class="fa fa-times"></i>
                            </a>
                        </li>
                    </ul>			
