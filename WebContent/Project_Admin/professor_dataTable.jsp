                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Professor</h1>                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.professorList}" >
                                                <tr>
                                                    <td>${i.addProfessorName}</td>
                                                    <td>${i.addProfessorDateOfBirth}</td>
                                                    <td>${i.addProfessorGender}</td>
                                                    <td>${i.addProfessorPosition}</td>
                                                    <td>${i.addProfessorEmail}</td>
                                                    <td>${i.branchVO.branchName}</td>
                                                    <td><a href="<%=request.getContextPath() %>/AddProfessorController?flag=EditProfessor&id=${i.addProfessorId}" >Edit</a>/<a href="<%=request.getContextPath() %>/AddProfessorController?flag=Delete&id=${i.addProfessorId}">Delete</a></td>
                                                </tr>
