                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Edit Post</h1>                            </div>
                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="postId" value="${i.postId }" required>
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="${i.postName}" name="PostName" class="form-control" id="field-1" required>
                                                </div>
                                            </div>
                                  			...
                                  			<div class="form-group">
                                                ...
                                                <div class="controls">
                                                	  	<textarea class="form-control autogrow" name="PostDescription" cols="5" id="field-5" required></textarea>
                                                 </div>
                                            </div>
