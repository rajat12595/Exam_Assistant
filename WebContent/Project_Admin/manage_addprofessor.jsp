                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add Professor</h1>                            </div>
                                    ...
                                    <form action ="<%=request.getContextPath()%>/AddProfessorController" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-1" name="AddProfessorName" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control datepicker" data-format="dd/mm/yyyy" value="" name="AddProfessorDateOfBirth" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <select class="form-control" name="AddProfessorGender">
                                                    <option></option>
                                                    <option >Male</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <select class="form-control " name="AddProfessorDepartement">
                                                    <option></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-1" name="AddProfessorPosition" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-3" name="AddProfessorEmail" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" name="AddProfessorPhone" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password" value="" class="form-control" id="field-2" name="AddProfessorPassword" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password"  value="" class="form-control" id="field-21" name="AddProfessorConfirmPassword" required>
                                                </div>
                                            </div>
                                        ...
                                        <input type="hidden" name="flag" value="InsertProfessor"/>   
