                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Edit Exam</h1>                            </div>
                                    ...
                                    <form action ="<%=request.getContextPath()%>/ExamController" method="post" name="cityForm" id="basicForm">
                                        ...
                                        <select class="form-control" name="stateId" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${i.examTitle}" class="form-control" id="field-1" name="ExamTitle" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc">e.g. "04/12/2015"</span>
                                                <div class="controls">
                                                    <input type="text" value="${i.examDate}" class="form-control datepicker" data-format="dd/mm/yyyy" value="" name="ExamDate" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            <div class="text-left">
                                           		...
                                           		<input type="hidden" name="flag" value="UpdateExam"/>
