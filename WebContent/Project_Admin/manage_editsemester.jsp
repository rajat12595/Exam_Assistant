                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Edit Semester</h1>                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <form action ="<%=request.getContextPath()%>/SemesterController" method="post">
                                    <c:forEach var="i" items="${sessionScope.SemesterList}">
                                    <input type="hidden" name="semesterId" value="${i.semId }">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">

                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Branch</label>
                                                <span class="desc"></span>
                                                <select class="form-control " name="SemBranch" required>
                                                    <option></option>
                                                    <c:forEach var="j" items="${sessionScope.branchlist}">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Semester Name</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" name="SemName" value="${i.semName}" class="form-control" id="field-1" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                	  	<textarea class="form-control autogrow" name="SemDes" cols="5" id="field-5" value="${i.semDes}" required></textarea>
                                                 </div>
                                            </div>
                                   </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            ...
                                            <input type="hidden" value="UpdateSemester" name="flag"/>
