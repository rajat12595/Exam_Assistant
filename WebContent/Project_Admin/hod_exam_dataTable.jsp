...
<html class=" ">
    ...
    <jsp:include page="header.jsp"></jsp:include>
        ...
        <div class="page-container row-fluid">
            ...
            <!-- SIDEBAR - START -->
            <jsp:include page="hod_menu.jsp"></jsp:include>
                        <!--  SIDEBAR - END -->
            <!-- START CONTENT -->
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Search Exam</h1>                            </div>
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.examList}">
                                                <tr>
                                                    ...
                                                    <td><a href="<%=request.getContextPath() %>/ExamController?flag=hodDelete&id=${i.examId}">Delete</a></td>
                                                </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
