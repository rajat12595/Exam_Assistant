                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add Class</h1>                            </div>
                                    ...
                                    <form action ="<%=request.getContextPath()%>/ClassController" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text"  class="form-control" name="classNumber" id="field-1" required>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Class Capacity</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" name="classCapacity" class="form-control" id="field-1" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Floor</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" name="classFloor" class="form-control" id="field-1" required>
                                                </div>
                                            </div>
                                  			...
                                  			<div class="form-group">
                                                ...
                                                <div class="controls">
                                                	  	<textarea class="form-control autogrow" name="classDes" cols="5" id="field-5" required></textarea>
                                                 </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            <div class="text-left">
                                            <input type="hidden" name="flag" value="insertClass"/>
