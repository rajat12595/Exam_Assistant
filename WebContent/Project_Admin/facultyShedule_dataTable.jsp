                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Faculty Schedule</h1>                            </div>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                            <c:forEach var="i" items="${sessionScope.FacultyList}">
                                                <tr>
                                                	
                                                    <td>${i.addProfessorVO.addProfessorName}</td>
                                                    <td>${i.examVO.examTitle}</td>
                                                    <td>${i.classBlockVO.classBlockTitle}</td>
                                                    <td><a href="<%=request.getContextPath() %>/FacultyController?flag=Delete&id=${i.facultyId}">Delete</a></td>
