                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Wages</h1>                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.wagesList}">
                                                <tr>
                                                    <td>${i.postVO.postName}</td>
                                                    <td>${i.wagesAmount}</td>
                                                    <td><a href="<%=request.getContextPath() %>/WagesController?flag=EditWages&id=${i.wagesId}" >Edit</a> / <a href="<%=request.getContextPath() %>/WagesController?flag=DeleteWages&id=${i.wagesId}">Delete</a></td>
