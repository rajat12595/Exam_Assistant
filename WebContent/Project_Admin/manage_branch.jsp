                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add Branch</h1>                            </div>
                                    ...
                                    <form action ="<%=request.getContextPath()%>/BranchController" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="" name="BranchName" class="form-control" id="field-1" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                	  	<textarea class="form-control autogrow" name="BranchDescription" cols="5" id="field-2" required></textarea>
                                                 </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" name="BranchCode" class="form-control" id="field-3" required>
                                                </div>
                                            </div>
									</div>
