                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add Class-Block</h1>                            </div>
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <form action ="<%=request.getContextPath()%>/ClassBlockController" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control " name="ClassBlockExam" required>
                                                    <option></option>
                                                     <c:forEach var="i" items="${sessionScope.examlist}">
                                                    
                                                    <option  value="${i.examId}">${i.examTitle}</option>
                                                    </c:forEach>
                                                 </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control " name="ClassBlockNumber" required>
                                                    ...
                                                    <option  value="${i.classId}">${i.classNumber}</option>
                                                    </c:forEach>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-1" name="ClassBlockTitle" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-1" name="ClassBlockSize" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
										...
										<input type="hidden" name="flag" value="InsertClassBlock"/>
