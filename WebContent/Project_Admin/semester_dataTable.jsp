                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Semester</h1>                            </div>
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.SemesterList}">
                                                <tr>
                                                    ...
                                                    <td>${i.semName}</td>
                                                    <td>${i.semDes}</td>
                                                    <td><a href="<%=request.getContextPath() %>/SemesterController?flag=EditSemester&id=${i.semId}" >Edit</a> / <a href="<%=request.getContextPath() %>/SemesterController?flag=DeleteSemester&id=${i.semId}">Delete</a></td>
                                                </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
