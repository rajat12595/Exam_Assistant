                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Edit Members</h1>                            </div>
                                    ...
                                    <form action ="<%=request.getContextPath()%>/StaffController" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-1" name="StaffName">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <select class="form-control " name="StaffDepatement">
                                                    <option></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-3" name="StaffEmail">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-1" name="StaffPostion">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="form-label" for="field-2">Phone</label>
                                                <span class="desc">(534) 253-5353</span>
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control" id="field-2" data-mask="phone"  placeholder="" name="StaffPhone">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="" class="form-control datepicker" data-format="dd/mm/yyyy" value="" name="StaffDateOfBirth">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password" value="" class="form-control" id="field-2" name="StaffPassword">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password"  value="" class="form-control" id="field-21" name="StaffConfirmPassword">
                                                </div>
                                            </div>
