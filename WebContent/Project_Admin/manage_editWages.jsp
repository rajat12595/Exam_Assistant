                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Edit Wages</h1>                            </div>
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <form action ="<%=request.getContextPath()%>/WagesController" method="post">
                                     ...
                                     <c:forEach var="i" items="${sessionScope.WagesList}">
                                    <input type="hidden" name="WagesId" value="${i.wagesId}" required>
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${i.wagesAmount}" class="form-control" id="field-1" name="WagesAmount" required>
                                                </div>
                                            </div>
                                            
                                            
          							<input type="hidden" name="flag" value="UpdateWages"/>                                  
                                   </div>
