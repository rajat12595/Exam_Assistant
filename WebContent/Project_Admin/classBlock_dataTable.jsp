                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Class-Block</h1>                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.classBlockList }">
                                                <tr>
                                                    <td>${i.examVO.examTitle }</td>
                                                    <td>${i.classVo.classNumber }</td>
                                                    <td>${i.classBlockTitle }</td>
                                                    <td>${i.classBlockSize }</td>
                                                    <td>${i.classBlockDescription }</td>
                                                    <td><a href="<%=request.getContextPath() %>/ClassBlockController?flag=EditClassBlock&id=${i.classBlockId}" >Edit</a> / <a href="<%=request.getContextPath() %>/ClassBlockController?flag=DeleteClassBlock&id=${i.classBlockId}">Delete</a></a></td>
