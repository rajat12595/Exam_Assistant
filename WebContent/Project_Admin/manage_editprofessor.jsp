                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <form action ="<%=request.getContextPath()%>/AddProfessorController" method="post">
                                    
                                    <c:forEach var="i" items="${sessionScope.ProfessorList}">
                                    <input type="hidden" name="AddProfessorId" value="${i.addProfessorId }">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="${i.addProfessorName}" class="form-control" id="field-1" name="AddProfessorName" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc">e.g. "dd/mm/yyyy"</span>
                                                <div class="controls">
                                                    <input type="text" value="${i.addProfessorDateOfBirth}" class="form-control datepicker" data-format="mm/dd/yyyy" value="" name="AddProfessorDateOfBirth" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <select class="form-control" name="AddProfessorGender" required>
                                                    <option></option>
                                                    <option >Male</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <select class="form-control " name="${i.branchVO.branchName}" required>
                                                    <option></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${i.addProfessorPosition}" class="form-control" id="field-1" name="AddProfessorPosition" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${i.addProfessorEmail}" class="form-control" id="field-3" name="AddProfessorEmail" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${i.addProfessorPhone}" class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" name="AddProfessorPhone" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password" value="${i.addProfessorPassword}" class="form-control" id="field-2" name="AddProfessorPassword" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="password"  value="${i.addProfessorConfirmPassword}" class="form-control" id="field-21" name="AddProfessorConfirmPassword" required>
                                                </div>
                                            </div>
										...
										<input type="hidden" name="flag" value="EditProfessor"/>
