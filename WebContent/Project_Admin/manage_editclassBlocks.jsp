                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Edit Block</h1>                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <form action ="<%=request.getContextPath()%>/ClassBlockController" method="post">
                                    <c:forEach var="i" items="${sessionScope.ClassBlockList}">
                                    <input type="hidden" name="classBlockId" value="${i.classBlockId}" required>
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">

                                             <div class="form-group">
                                                <label class="form-label" for="field-1">Exam</label>
                                                <span class="desc"></span>
                                                <select class="form-control " name="ClassBlockExam" required>
                                                    <option></option>
                                                     <c:forEach var="j" items="${sessionScope.examlist}">
                                                    
                                                    <option  value="${j.examId}">${j.examTitle}</option>
                                                    </c:forEach>
                                                 </select>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Class Number</label>
                                                <span class="desc"></span>
                                                <select class="form-control " name="ClassBlockNumber" required>
                                                    <option></option>
                                                     <c:forEach var="k" items="${sessionScope.classlist}">
                                                    
                                                    <option  value="${k.classId}">${k.classNumber}</option>
                                                    </c:forEach>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Block Title</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${i.classBlockTitle}" class="form-control" id="field-1" name="ClassBlockTitle" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Block Size</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${i.classBlockSize}" class="form-control" id="field-1" name="ClassBlockSize" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                	  	<textarea class="form-control autogrow" cols="5" id="field-5" name="ClassBlockDescription" required></textarea>
                                                 </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            ...
                                            <input type="hidden" name="flag" value="UpdateClassBlock"/>
