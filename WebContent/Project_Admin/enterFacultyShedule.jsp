                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add Faculty Schedule</h1>                            </div>
                                    ...
                                    <form action ="<%=request.getContextPath()%>/FacultyController" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                	  	<textarea class="form-control autogrow" cols="5" id="field-5" name="ScheduleDescription" required></textarea>
                                                 </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            <div class="text-left">
                                                <input type="hidden" name="flag" value="SFaculty"/>
