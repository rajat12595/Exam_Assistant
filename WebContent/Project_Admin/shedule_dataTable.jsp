...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>View Faculty Schedule</title>
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <c:forEach var="i" items="${sessionScope.ScheduleList}">
                                                <tr>
                                                    ...
                                                    <td>${i.descreiption}</td>
                                                    <td><a href="<%=request.getContextPath() %>/FacultyController?flag=DeleteSchedule&id=${i.scheduleId}">Delete</a></td>
                                                </tr>
                                                </c:forEach>
                                            </tbody>
