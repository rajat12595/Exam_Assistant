...
<script type="text/javascript" src="<%=request.getContextPath()%>/Project_Admin/js/jscharts.js"></script>
</head>
<body>
 ...
 */
	...
	//	myChart.colorizeBars(colors);
		...
		myChart.colorizeBars(getColorArray(myData.length));
		myChart.setTitle('Class Block Chart');
		myChart.setTitleColor('#8C8382');
		myChart.setAxisNameX('Class No');
