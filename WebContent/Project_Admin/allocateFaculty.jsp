                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Allocate Faculty</h1>                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <form action ="<%=request.getContextPath()%>/FacultyController" method="post">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">

                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Faculty</label>
                                                <span class="desc"></span>
                                                <select class="form-control" name="id" required>
                                                    <option></option>
                                                     <c:forEach var="i" items="${sessionScope.professorlist}">
                                                    
                                                    <option  value="${i.addProfessorId}">${i.addProfessorName}</option>
                                                    </c:forEach>
                                                 </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Class-Block</label>
                                                <span class="desc"></span>
                                                <select class="form-control" name="classBlock" required>
                                                    <option></option>
                                                    <c:forEach var="i" items="${sessionScope.classBlockList}">
                                                    
                                                    <option  value="${i.classBlockId}">${i.classBlockTitle}</option>
                                                    </c:forEach>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            <div class="text-left">
                                                ...
                                                <input type="hidden" name="flag" value="insertFaculty"/>
